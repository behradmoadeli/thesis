...
\begin{figure}[!htbp]
    ...
    \label{fig:reactor_scheme_cjce1}
\end{figure}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.8\textwidth, keepaspectratio]{papers/1_optimal/figures/eig_val_dist_R_0.3.svg}
...
\begin{figure}[H]
    \centering
    \includesvg[inkscapelatex=false, width=0.6\textwidth, keepaspectratio]{papers/1_optimal/figures/eigfuns.svg}
