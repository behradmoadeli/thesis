...
\begin{figure}[!htbp]
    ...
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth,trim=0 0 100 0,clip]{papers/1_optimal/figures/3D_x1_k3.png}
        \caption{$N=3$}
        \label{fig:1_3D_x1_k3}
    \end{subfigure}
    \hfill
    \begin{subfigure}[b]{0.45\textwidth}
        \includegraphics[width=\textwidth,trim=0 0 100 0,clip]{papers/1_optimal/figures/3D_x1_k7.png}
        \caption{$N=7$}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.8\textwidth, keepaspectratio]{papers/1_optimal/figures/2D_xt_k7.svg}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.8\textwidth,trim=0 0 100 0,clip]{papers/1_optimal/figures/3D_x1_L_k7.png}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.8\textwidth, keepaspectratio]{papers/1_optimal/figures/2D_xt_L_k7.svg}
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=0.8\textwidth,trim=0 0 100 0,clip]{papers/1_optimal/figures/3D_e1_L_k7.png}
...
\begin{figure}[!htbp]
    \centering
    \includesvg[inkscapelatex=false, width=0.8\textwidth, keepaspectratio]{papers/1_optimal/figures/2D_et_L_k7.svg}
